...
class todo():
    def __init__(self, root):
        ...
        self.root.geometry('750x510+300+150')

        self.label = Label(self.root, text='to do list',
              font='algerian, 25 bold', width=10,bd=5,bg='purple',fg='black')
        self.label.pack(side='top',fill=BOTH)

        self.label2 = Label(self.root, text='Add task',
              font='algerian, 18 bold', width=10,bd=5,bg='purple',fg='black')
        ...
        self.label3 = Label(self.root, text='Tasks',
              font='algerian, 18 bold', width=10,bd=5,bg='purple',fg='black')
        self.label3.place(x=360, y=154)

        self.main_text = Listbox(self.root, height=9, bd=5,width=25, font="algerian, 20 italic bold")
        self.main_text.place(x=280, y=200)

        self.text = Text(self.root, bd=5, height=2, width=30, font='ariel, 10 bold')
        self.text.place(x=340, y=100)
